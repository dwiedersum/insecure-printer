...
class printer_testcase extends TestCase {
    ...
    public function test_print_lines_of_text_file(){
        $this->assertEquals("was ich\n",
                            printer\print_line_of_file("/source/insecure_printer/bin/print",
                            ".txt", 2));
    }
    ...
    public function test_implode_lines_of_text(){
        $this->assertEquals("Hallo\nich weiss\nwas ich\nmache\n", printer\implode_array_of_lines_of_file("../bin/print", ".txt"));
    }

    public function test_overwrite_file_content(){
        $this->assertEquals("Ich wollte sagen:     Hallo     wenn es dir recht ist.\n",
                            printer\overwrite_file_content("/source/insecure_printer/bin/print", ".txt", "Hallo", 5, 0));
    }
}
